...
llm = curator.LLM(
    ...
    backend_params={"base_url": "https://openrouter.ai/api/v1", "api_key": os.environ.get("OPENROUTER_API_KEY"), "max_retries": 1},
)

# Using litellm backend
# Getting litellm.exceptions.APIError: litellm.APIError: APIError: OpenrouterException -
# llm = curator.LLM(model_name="openrouter/deepseek/deepseek-r1",
#                    generation_params={"include_reasoning": True},
