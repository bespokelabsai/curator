...
from bespokelabs.curator.status_tracker.online_status_tracker import OnlineStatusTracker, _TokenInfo
...
class OpenAIOnlineRequestProcessor(BaseOnlineRequestProcessor, OpenAIRequestMixin):
    ...
    def estimate_total_tokens(self, messages: list) -> dict:
        ...
        return _TokenInfo(**{"input": num_tokens, "output": output_tokens})
